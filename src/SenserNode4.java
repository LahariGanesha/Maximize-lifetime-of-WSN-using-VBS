...
public class SenserNode4 extends Frame implements ActionListener {
...
//    				infoText.setText(strLine);
    				flag = !flag;
    				if (flag){
    					SetStatus("Node 4 - Active");
    				} else {
       					SetStatus("Node 4 - Sleeping");
    				}
...
// add to send-info
    		try{
    			...
    			String message;
    			requestSocket = new Socket(intermediate_Node6_ip, 3114);
    			System.out.println("Connected to localhost in port 3114");
    			//2. get Input and Output streams
    			out = new ObjectOutputStream(requestSocket.getOutputStream());
    			out.flush();
    			message = infoText.getText() + "(Path:Node-4,";   			
...
//        toolbarPanel.setLayout(new () );
       ...
       // toolbarPanel.add(tl2,2);
		...
		Thread t1 = new Thread (new PortListener(2114));
		t1.setName("Togel node-4");
		t1.start();
    ...
    public static void main(String[] args) {
    	...
    	SenserNode4 mainFrame = new SenserNode4();
